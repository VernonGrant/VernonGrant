...
#+SUBTITLE: The past few months I went on a little excursion through the world of lisp programming languages
#+DESCRIPTION: The past few months I went on a little excursion through the world of lisp programming languages. My intention is to find that one language that I could invest my efforts into for the long run.
