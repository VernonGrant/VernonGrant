...
#+SUBTITLE: For the past few months I went on a little excursion through the world of lisp languages
...
For the past few months I went on a little excursion through the world of lisp languages. *My intention is to find that one language that I could invest my efforts into for the long run*. I want to specialize in this languages and use it for all the projects/products I'm going to develop through out the rest of my career.
...
But, I think this comes down to the individual. Everyone is different, for me Lisp languages are easier to read and understand and I love the aesthetics of nicely formatted Lisp.

** Guile Scheme

I started off with Guile Scheme and learned about the different scheme standards such as =R5RS=, =R6RS= and =R7RS=. Which is basically the same concept as C standards, where each standard introduces a new set of core language features. Another interesting thing about Scheme is [[https://srfi.schemers.org/][SRFIs]], which is community driven language features. During my time with Guile Scheme I developed this simple [[https://github.com/VernonGrant/guile-markup][markup generator]] as a learning exercise.
...
The entire reason I've been exploring so many different languages the past year was to find that one language I could invest my efforts into for the long run. And so Common Lisp is basically the language I was looking for.

Its is not perfect, some might say its bloated and difficult to learn. Others critique it for not being strictly functional. Some say its old and outdated. And I wished the development tooling was better in editors outside of Emacs.

This might all be true, but after using it, I don't care.

*Its an absolute powerhouse of a language*. Its *stable*, you can write a piece of code today and run it 10 years later without issue. Its *fast*, like basically C level fast. It has *arbitrary precision arithmetic*, so no overflows. It has *zero churn*. And the language is packed with great utilities and a wonderful package ecosystem.
...
And so I've landed on Common Lisp as the lisp language I will be investing in for the rest of my career. I will be writing a lot more about Common Lisp and how I'm using it to build my first SAAS product in the near future.
